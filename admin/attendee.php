      ...
      <div class="pageheader">
        ...
        <div class="maincontent">
         <div class="maincontentinner">
           ...
           <h4 class="widgettitle">Attendee Details</h4>
...
$rest = mysqli_query($conn, "SELECT * FROM `attendee_info` ");
                             ...
                             <td class="center">
                               ...
                               <!--  <a title="View" href='view_tourist_info.php?id=<?php echo $row['id'];?>'>View</a>
                                ...
                                |<a title="Edit" href='edit_tourist_info.php?id=<?php echo $row['id'];?>'>Edit</a> -->
                                     ...
                                     <a title="Delete" href='delete.php?url3=<?php echo $row['user_id'];?>'>Delete</a> 
                          </td>
