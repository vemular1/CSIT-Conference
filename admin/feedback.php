      ...
      <div class="pageheader">
        ...
        <div class="maincontent">
         <div class="maincontentinner">
           ...
           <h4 class="widgettitle">Feedback Details</h4>
                        ...
                        <tr>
                              ...
                              <th class="head0"style="min-width:10%">Last Name</th>
                               <th class="head0"style="min-width:10%">Email</th>
                                ...
                                <th class="head0"style="min-width:10%;">Feedback</th>
                                <th class="head0"style="min-width:10%;">comment</th>
...
$rest = mysqli_query($conn, "SELECT * FROM  `feedback` ORDER BY  `id` DESC");
                            ...
                            <td ><?php echo $row['feedback'];?></td>
                             ...
                             <td class="center">
                                ...
                                <!-- |<a title="Edit" href='edit_tourist_info.php?id=<?php echo $row['id'];?>'>Edit</a> -->
                                     ...
                                     <a title="Delete" href='delete.php?url4=<?php echo $row['id'];?>'>Delete</a> 
                          </td>
