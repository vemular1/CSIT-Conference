      ...
      <div class="pageheader">
        ...
        <div class="maincontent">
         <div class="maincontentinner">
           ...
           <h4 class="widgettitle">Student Details</h4>
                        ...
                        <tr>
                            ...
                            <th class="head0"style="min-width:5%">Id</th>
                              ...
                              <th class="head0"style="min-width:10%">Last Name</th>
                               ...
                               <th class="head0"style="min-width:10%">Research Paper</th>
...
$rest = mysqli_query($conn, "SELECT * FROM `student_info` ");
...
?> <td class="aligncenter"><?php echo $k;?></td>
                            ...
                            <td ><?php echo $row['address']; ?></td>
                             ...
                             |<a title="Edit" href='edit_tourist_info.php?id=<?php echo $row['id'];?>'>Edit</a> -->
                                      ...
                                      <a title="Delete" href='delete.php?url1=<?php echo $row['user_id'];?>'>Delete</a> 
                          </td>
